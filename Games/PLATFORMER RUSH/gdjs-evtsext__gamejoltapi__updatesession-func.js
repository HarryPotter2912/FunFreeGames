...
gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback25141812 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__UpdateSession.idToCallbackMap.set(25141812, gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback25141812);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "sessions/ping", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback25141812(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25141812, asyncObjectsList);
}
}
