...
gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback25208164 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchData.idToCallbackMap.set(25208164, gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback25208164);
...
};gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback25209284 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchData.idToCallbackMap.set(25209284, gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback25209284);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback25209284(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25209284, asyncObjectsList);
}
}
