...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25169380 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(25169380, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25169380);
...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25172084 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(25172084, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25172084);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25172084(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25172084, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25173604 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(25173604, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25173604);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback25173604(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25173604, asyncObjectsList);
}
}
