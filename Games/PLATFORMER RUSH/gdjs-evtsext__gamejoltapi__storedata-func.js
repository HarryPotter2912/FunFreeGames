...
gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25213380 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__StoreData.idToCallbackMap.set(25213380, gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25213380);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/set", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25213380(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25213380, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25214284 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__StoreData.idToCallbackMap.set(25214284, gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25214284);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/set", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__StoreData.asyncCallback25214284(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25214284, asyncObjectsList);
}
}
