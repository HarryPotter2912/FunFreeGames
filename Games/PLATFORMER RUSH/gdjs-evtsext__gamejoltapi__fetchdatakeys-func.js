...
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25237732 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.idToCallbackMap.set(25237732, gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25237732);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/get-keys", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25237732(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25237732, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25238716 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.idToCallbackMap.set(25238716, gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25238716);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/get-keys", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback25238716(runtimeScene, eventsFunctionContext, asyncObjectsList)), 25238716, asyncObjectsList);
}
}
