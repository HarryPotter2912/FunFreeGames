...
gdjs.Level2Code.GDGameOverDialogObjects5= [];
...
gdjs.Level2Code.GDScreenOrientationCheckerObjects5= [];
gdjs.Level2Code.GDTransparentDarkJoystickObjects1= [];
gdjs.Level2Code.GDTransparentDarkJoystickObjects2= [];
gdjs.Level2Code.GDTransparentDarkJoystickObjects3= [];
gdjs.Level2Code.GDTransparentDarkJoystickObjects4= [];
gdjs.Level2Code.GDTransparentDarkJoystickObjects5= [];


gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDJoystickObjects3Objects = Hashtable.newFrom({"Joystick": gdjs.Level2Code.GDJoystickObjects3});
gdjs.Level2Code.eventsList0 = function(runtimeScene) {

{

gdjs.copyArray(runtimeScene.getObjects("Joystick"), gdjs.Level2Code.GDJoystickObjects3);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__SpriteMultitouchJoystick__HasTouchStartedOnScreenSide.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDJoystickObjects3Objects, "Left", null);
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDJoystickObjects3 */
{for(var i = 0, len = gdjs.Level2Code.GDJoystickObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDJoystickObjects3[i].TeleportAndPress(null);
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25560284);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25561156);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.Level2Code.GDJumpButtonObjects3 */
{for(var i = 0, len = gdjs.Level2Code.GDJumpButtonObjects3.length ;i < len;++i) {
    gdjs.Level2Code.GDJumpButtonObjects3[i].setColor("255;255;255");
}
}
}
...
let isConditionTrue_0 = false;
{
{gdjs.evtsExt__PokiGamesSDKHtml__CallGameplayStart.func(runtimeScene, null);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25564236);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__Player__IsSteppingOnFloor.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, "PlatformerObject", null);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25564884);
}
}
if (isConditionTrue_0) {
...
/* Reuse gdjs.Level2Code.GDPlayerObjects2 */
{gdjs.evtsExt__Checkpoints__SaveCheckpoint.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, (( gdjs.Level2Code.GDCheckpointObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCheckpointObjects2[0].getPointX("")), (( gdjs.Level2Code.GDCheckpointObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDCheckpointObjects2[0].getPointY("")), "Checkpoint", null);
}
...
if (isConditionTrue_0) {
{gdjs.evtsExt__PokiGamesSDKHtml__CallGameplayStop.func(runtimeScene, null);
}
{gdjs.evtsExt__PokiGamesSDKHtml__RequestCommercialBreak.func(runtimeScene, null);
}
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "menuover", false);
}
...
{gdjs.evtsExt__Enemy__TriggerFlyDeath.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDFlyObjects3Objects, "RectangleMovement", "ShakeObject_PositionAngle", null);
}
{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects3Objects, "PlatformerObject", null);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = !(gdjs.evtsExt__Enemy__IsFlyDead.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDFlyObjects2Objects, null));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
{gdjs.evtTools.object.createObjectOnScene(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDMonsterParticlesObjects2Objects, (( gdjs.Level2Code.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDMonsterObjects2[0].getCenterXInScene()), (( gdjs.Level2Code.GDMonsterObjects2.length === 0 ) ? 0 :gdjs.Level2Code.GDMonsterObjects2[0].getCenterYInScene()), "");
}
{gdjs.evtsExt__Player__Bounce.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, "PlatformerObject", null);
}
{runtimeScene.getScene().getVariables().getFromIndex(0).add(50);
}
}
...
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMonsterObjects2.length;i<l;++i) {
    if ( gdjs.Level2Code.GDMonsterObjects2[i].getBehavior("MonsterEnemy").IsOnFire(null) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.Level2Code.GDMonsterObjects1.length;i<l;++i) {
    if ( !(gdjs.Level2Code.GDMonsterObjects1[i].getBehavior("MonsterEnemy").IsOnFire(null)) ) {
        isConditionTrue_0 = true;
...
gdjs.copyArray(asyncObjectsList.getObjects("Portal"), gdjs.Level2Code.GDPortalObjects4);
...
{gdjs.evtsExt__Player__AnimateFallingIntoPortal.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects4Objects, "Tween", gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPortalObjects4Objects, null);
}
}
...
};gdjs.Level2Code.asyncCallback25586972 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Level2Code.localVariables);
{runtimeScene.getGame().getVariables().getFromIndex(6).setString("Level 2");
}
{runtimeScene.getGame().getVariables().getFromIndex(5).setNumber(800);
}
...
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "good", false);
}
...
gdjs.Level2Code.idToCallbackMap.set(25586972, gdjs.Level2Code.asyncCallback25586972);
...
for (const obj of gdjs.Level2Code.GDPortalObjects2) asyncObjectsList.addObject("Portal", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Level2Code.asyncCallback25586972(runtimeScene, asyncObjectsList)), 25586972, asyncObjectsList);
}
}
...
};gdjs.Level2Code.asyncCallback25590788 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Level2Code.localVariables);
{runtimeScene.getGame().getVariables().getFromIndex(6).setString("Level 2");
}
{runtimeScene.getGame().getVariables().getFromIndex(5).setNumber(800);
...
gdjs.Level2Code.idToCallbackMap.set(25590788, gdjs.Level2Code.asyncCallback25590788);
...
for (const obj of gdjs.Level2Code.GDPlayerObjects2) asyncObjectsList.addObject("Player", obj);
for (const obj of gdjs.Level2Code.GDPortalObjects2) asyncObjectsList.addObject("Portal", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Level2Code.asyncCallback25590788(runtimeScene, asyncObjectsList)), 25590788, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25595156);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("GameOverDialog"), gdjs.Level2Code.GDGameOverDialogObjects2);
{for(var i = 0, len = gdjs.Level2Code.GDGameOverDialogObjects2.length ;i < len;++i) {
    gdjs.Level2Code.GDGameOverDialogObjects2[i].SetScore(runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber(), null);
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("GameOverDialog"), gdjs.Level2Code.GDGameOverDialogObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Level2Code.GDGameOverDialogObjects1.length;i<l;++i) {
    if ( gdjs.Level2Code.GDGameOverDialogObjects1[i].IsRetryClicked(null) ) {
        isConditionTrue_0 = true;
        gdjs.Level2Code.GDGameOverDialogObjects1[k] = gdjs.Level2Code.GDGameOverDialogObjects1[i];
        ++k;
    }
}
gdjs.Level2Code.GDGameOverDialogObjects1.length = k;
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25586308);
}
}
}
if (isConditionTrue_0) {
...
{gdjs.evtsExt__Player__AnimateFallingIntoPortal.func(runtimeScene, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects2Objects, "Tween", gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPortalObjects2Objects, null);
}
{runtimeScene.getGame().getVariables().getFromIndex(2).setString("Level 3");
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(25590644);
}
}
}
if (isConditionTrue_0) {
...
{gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.func(runtimeScene, 0, "Sound", gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPortalObjects1Objects, gdjs.Level2Code.mapOfGDgdjs_9546Level2Code_9546GDPlayerObjects1Objects, 0, 20, 750, null);
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Fly"), gdjs.Level2Code.GDFlyObjects1);
gdjs.copyArray(runtimeScene.getObjects("Monster"), gdjs.Level2Code.GDMonsterObjects1);
gdjs.copyArray(runtimeScene.getObjects("Platform2"), gdjs.Level2Code.GDPlatform2Objects1);
{}
{}
{for(var i = 0, len = gdjs.Level2Code.GDFlyObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDFlyObjects1[i].getBehavior("RectangleMovement").SetHorizontalEdgeDuration(100 / (150 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 15), null);
}
}
{for(var i = 0, len = gdjs.Level2Code.GDFlyObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDFlyObjects1[i].getBehavior("RectangleMovement").SetVerticalEdgeDuration(100 / (150 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 15), null);
}
}
{for(var i = 0, len = gdjs.Level2Code.GDPlatform2Objects1.length ;i < len;++i) {
    gdjs.Level2Code.GDPlatform2Objects1[i].getBehavior("RectangleMovement").SetHorizontalEdgeDuration(100 / (50 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 5), null);
}
}
{for(var i = 0, len = gdjs.Level2Code.GDPlatform2Objects1.length ;i < len;++i) {
    gdjs.Level2Code.GDPlatform2Objects1[i].getBehavior("RectangleMovement").SetVerticalEdgeDuration(100 / (50 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 5), null);
}
}
{for(var i = 0, len = gdjs.Level2Code.GDCheckpointObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDCheckpointObjects1[i].getBehavior("RectangleMovement").SetHorizontalEdgeDuration(100 / (70 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 7), null);
}
}
{for(var i = 0, len = gdjs.Level2Code.GDCheckpointObjects1.length ;i < len;++i) {
    gdjs.Level2Code.GDCheckpointObjects1[i].getBehavior("RectangleMovement").SetVerticalEdgeDuration(100 / (70 + runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber() * 7), null);
}
}
}
...
gdjs.Level2Code.GDGameOverDialogObjects5.length = 0;
...
gdjs.Level2Code.GDScreenOrientationCheckerObjects5.length = 0;
gdjs.Level2Code.GDTransparentDarkJoystickObjects1.length = 0;
gdjs.Level2Code.GDTransparentDarkJoystickObjects2.length = 0;
gdjs.Level2Code.GDTransparentDarkJoystickObjects3.length = 0;
gdjs.Level2Code.GDTransparentDarkJoystickObjects4.length = 0;
gdjs.Level2Code.GDTransparentDarkJoystickObjects5.length = 0;
